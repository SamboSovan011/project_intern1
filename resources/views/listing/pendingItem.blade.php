                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-success btn-sm" href="{{route('approveSlide', ['id' => $slide->id])}}"><span
                                                class="glyphicon glyphicon-ok">Approved</span></a>

                                    </td>
                                    <td>
                                        <a class="btn btn-danger btn-sm" href="{{route('blockSlide', ['id' => $slide->id])}}"><span
                        ...
                        <table id="dataTableCate" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success btn-sm" href="{{route('approveCategory', ['id' => $cate->id])}}"><span
                                                class="glyphicon glyphicon-ok">Approved</span></a>

                                    </td>
                                    <td>
                                        <a class="btn btn-danger btn-sm" href="{{route('blockCategory', ['id' => $cate->id])}}"><span
                                                class="glyphicon glyphicon-remove">Block</span></a>
                                    </td>
                                </tr>
                                @endforeach
